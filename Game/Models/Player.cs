...
namespace Chinese_Chess_v3.Game.Models
{
    ...
    public class Player
    {
        ...
        public Player(PlayerSide side, TimeSpan totalTimeLimit, TimeSpan stepTimeLimit, TimerMode mode = TimerMode.CountDown)
        {
            Side = side;
            Timer = new PlayerTimer(totalTimeLimit, stepTimeLimit, mode);
        }
