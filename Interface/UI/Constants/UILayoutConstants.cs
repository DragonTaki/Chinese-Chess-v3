...
namespace Chinese_Chess_v3.Interface.UI.Constants
{
    ...
    {        
        ...
        public class MainMenu
        {
            ...
            // Size
            public static readonly Vector2F Size = new Vector2F(360.0f, 840.0f);
            ...
            {
                // Location start point
                public static readonly Vector2F Position = new Vector2F(Margin, Margin);
                // Size
                public static readonly Vector2F Size = new Vector2F(MainMenu.Size.X - Margin * 2, MainMenu.Size.Y - Margin * 2);
            }
            ...
            {
                // Location start point
                public static readonly Vector2F Position = new Vector2F(0.0f, Margin);
                // Size
                public static readonly Vector2F Size = new Vector2F(ScrollContainer.Size.X, 60.0f);
            }
        ...
        public class Board
        {
            ...
            // Size
            public static readonly Vector2F Size = new Vector2F(840.0f, MainMenu.Size.Y);
