...
namespace Chinese_Chess_v3.Interface.GameBoard
{
    public class PieceRenderer
    {
        ...
        {
            int centerX = BoardSettings.BoardStartX + piece.X * BoardSettings.GridSize;
            int centerY = BoardSettings.BoardStartY + piece.Y * BoardSettings.GridSize;
            ...
            if (isSelected)
            {
                int glowRadius = radius + PieceSettings.GlowMargin;
